...
import aboutme from '../assets/saurabh.jpeg';
    ...
    <div className="bg-black text-white py-12" id="about">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12">
          <img
            className="w-72 h-80 object-cover mb-8 rounded md:mb-0"
            src={aboutme}
            alt="About Me"
          />
          <div className="flex-1">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                <label className="w-2/12">ReactJs</label>
                <div className="grow bg-gray-800 rounded-full h-2.5">
              ...
              <div className="flex items-center">
                <label className="w-2/12">NodeJS</label>
                <div className="grow bg-gray-800 rounded-full h-2.5">
